        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Contactez-nous</p>
            </div>

            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:contact@finexia.pro"
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Disponible 24/7</p>
              </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              <div
                ...
                style={{ transitionDelay: "200ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Nom</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Message envoyé avec succès!</p>
                )}
              </div>
            </form>
          </div>
